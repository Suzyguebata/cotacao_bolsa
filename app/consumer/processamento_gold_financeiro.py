...
def main():
    log_event(logger, logging.INFO, "spark_gold_financial_starting", caminho_entrada=SILVER_PATH, caminho_saida=GOLD_PATH, caminho_checkpoint=CHECKPOINT_GOLD)
    aguardar_silver()
    ...
    log_event(logger, logging.INFO, "spark_gold_financial_stream_started", caminho_entrada=SILVER_PATH, caminho_saida=GOLD_PATH, caminho_checkpoint=CHECKPOINT_GOLD)

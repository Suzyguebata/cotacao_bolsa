...
from consumer.transformations import transform_silver_to_gold_operational
...
GOLD_PATH = os.getenv("GOLD_OPERATIONAL_PATH", f"s3a://{DATA_LAKE_BUCKET}/gold/media_precos_ingestao_5min")
CHECKPOINT_GOLD = os.getenv("CHECKPOINT_GOLD_OPERATIONAL", f"s3a://{DATA_LAKE_BUCKET}/checkpoints/gold_operacional_cotacoes")
...
def main():
    ...
    df_gold = transform_silver_to_gold_operational(df_silver)
